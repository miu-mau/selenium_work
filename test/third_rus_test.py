...
def test_login(pages, email, password):
    ...
    login_page.login_rus(email, password)
    time.sleep(2)
...
def test_add_macbook_to_wishlist(pages):
    ...
    time.sleep(2)
    product_page.add_to_wishlist_rus()
    time.sleep(1)
...
def test_add_samsung_tablet_to_cart(pages):
    ...
    home_page.click_catalog_rus("tablet")
    time.sleep(1)
    home_page.scroll_down(200)
    time.sleep(2)
    home_page.add_to_cart_rus("Samsung Galaxy Tab 10.1")
    time.sleep(1)
...
def test_add_htc_to_cart(pages):
    home_page, _, _, _, _ = pages
    home_page.click_catalog_rus("smartphone")
    time.sleep(1)
    home_page.scroll_down(200)
    time.sleep(1)
    home_page.add_to_cart_rus("HTC Touch HD")
    time.sleep(1)
